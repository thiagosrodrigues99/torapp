          ...
          <div className="bg-white dark:bg-surface-dark rounded-xl p-5 shadow-sm space-y-5 border border-gray-200 dark:border-white/5">
            ...
            <div className="p-4 rounded-lg bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 flex items-center gap-3">
              ...
              <div className="flex-1">
                <h4 className="text-gray-900 dark:text-white font-bold text-sm">Flexão de Braços</h4>
        ...
        <section className="mt-6 px-4 pb-10 flex-1">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex items-center gap-2">
              <span className="bg-gray-200 dark:bg-surface-dark text-gray-600 dark:text-gray-400 px-3 py-1 rounded-full text-xs font-medium whitespace-nowrap">2 Exercícios</span>
            </div>
          </div>
          
          <div className="space-y-3">
            <WorkoutListItem title="Polichinelo" category="Cardio" reps="3x 1 min" />
            <WorkoutListItem title="Agachamento Livre" category="Pernas" reps="3x 15 reps" />
          </div>
